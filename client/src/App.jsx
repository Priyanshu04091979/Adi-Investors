            ...
            <AnimatePresence>
              {!isChatOpen && showTooltip && (
                <motion.div
                  ...
                  className="absolute bottom-[28px] right-0 bg-[#0f172a] text-white p-4 rounded-2xl shadow-[0_10px_25px_rgba(0,0,0,0.2)] border border-slate-700 w-64 flex flex-col items-start gap-1 text-sm font-sans"
